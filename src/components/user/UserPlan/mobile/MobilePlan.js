...
import './mobilePlan.css';  // use BEM

class MobilePlan extends Component {  // convert to functional w/ hooks
...
export default withRouter(connect(mapStateToProps)(MobilePlan));