...
const MobileLeftNav = props => {
  ...
  return (
    <div className="mobile-left-nav">
      ...
      {
        !isAuthenticated &&
        <NavLink className="mobile-left-nav-link" activeStyle={{backgroundColor}} onTouchEnd={() => { closeNav('/user/register')}} to="/user/register">Create Account</NavLink>
      }
      {
        !isAuthenticated
        ? <NavLink className="mobile-left-nav-link" activeStyle={{backgroundColor}} onTouchEnd={() => { closeNav('/dashboard')}} to="/dashboard">Dashboard</NavLink>
        : <NavLink className="mobile-left-nav-link" activeStyle={{backgroundColor}} onTouchEnd={() => { closeNav('/user/dashboard')}} to="/user/dashboard">{authname}</NavLink>
      }
      {
        !isAuthenticated
        ? <NavLink className="mobile-left-nav-link" activeStyle={{backgroundColor}} onTouchEnd={() => { closeNav('/planner')}} to="/planner">Planner</NavLink>
        : <NavLink className="mobile-left-nav-link" activeStyle={{backgroundColor}} onTouchEnd={() => { closeNav('/user/planner')}} to="/user/planner">Planner</NavLink>
      }
      ...
      {
        !isAuthenticated
        ? <NavLink className="mobile-left-nav-link" activeStyle={{backgroundColor}} onTouchEnd={() => { closeNav('/messenger')}} to="/messenger">Messenger</NavLink>
        : <NavLink className="mobile-left-nav-link" activeStyle={{backgroundColor}} onTouchEnd={() => { closeNav('/user/messenger')}} to="/user/messenger">Messenger</NavLink>
      }
      {
        !isAuthenticated
        ? <NavLink className="mobile-left-nav-link" activeStyle={{backgroundColor}} onTouchEnd={() => { closeNav('/friends')}} to="/friends">Friends</NavLink>
        : <NavLink className="mobile-left-nav-link" activeStyle={{backgroundColor}} onTouchEnd={() => { closeNav('/user/friends')}} to="/user/friends">Friends</NavLink>
      }
